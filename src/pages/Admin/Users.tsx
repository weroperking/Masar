  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-slate-900">{users?.length || 0}</span>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
          <p className="text-sm font-medium text-slate-500 mb-1">المدراء</p>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-slate-900">{users?.filter(u => u.role === 'admin').length || 0}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 text-center h-48 flex flex-col justify-center items-center">
        ...
        <h2 className="text-lg font-semibold text-slate-700">قائمة المستخدمين</h2>
