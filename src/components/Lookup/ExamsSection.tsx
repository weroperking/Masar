              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold border ${evaluation.color}`}>
                      {evaluation.label}
                    </span>
                  </div>
                  {exam.date && (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <div className="text-left">
                    ...
                    <span className="text-[10px] font-mono text-slate-500 dark:text-slate-400 block text-left">
                      {pct}%
                    </span>
                  </div>
