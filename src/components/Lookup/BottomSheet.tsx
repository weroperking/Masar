...
export function BottomSheet({
  ...
  subtitle,
  children,
  maxHeight = 'max-h-[100dvh] sm:max-h-[96vh]',
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className={`relative w-full max-w-4xl lg:max-w-5xl bg-white dark:bg-slate-900 rounded-t-[24px] sm:rounded-xl shadow-2xl border-t sm:border border-slate-200/80 dark:border-slate-800 h-full sm:h-auto ${maxHeight} flex flex-col z-10 overflow-hidden animate-in slide-in-from-bottom-5 sm:zoom-in-95 duration-150`}
          >
