...
export function QuickNewModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-start justify-center pt-0 sm:pt-12 sm:pt-16 p-0 sm:p-4 bg-black/60 backdrop-blur-xs" dir="rtl" onClick={onClose}>
      <div 
