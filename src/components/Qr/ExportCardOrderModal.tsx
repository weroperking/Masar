...
export function ExportCardOrderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs overflow-y-auto">
      <div 
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-xl overflow-hidden shadow-2xl my-4 sm:my-8 animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]"
        dir="rtl"
      >
        {/* Header */}
