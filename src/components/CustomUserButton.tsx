  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-xs font-semibold text-slate-800 dark:text-slate-200 hidden sm:block max-w-[130px] truncate tracking-tight">
          {teacherDisplayName}
        </span>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-60 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden z-50 origin-top-left animate-in fade-in zoom-in-95 duration-100">
          {/* User Info Header */}
          <div className="p-3.5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-slate-200 dark:bg-slate-700 ring-1 ring-slate-200 dark:ring-slate-700 flex items-center justify-center overflow-hidden shrink-0">
                <img
                  src="/download.png"
                  alt="Profile"
                  className="w-full h-full object-cover"
